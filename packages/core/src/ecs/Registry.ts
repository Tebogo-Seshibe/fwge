...
import { EntityEntry, View, ViewConfig, ViewFilter, ViewIterator, ViewIteratorValue, ViewKey } from "../base";
            ...
            [Symbol.iterator]: function() {
                ...
                return {
                    next: (): ViewIteratorValue<E, T> => {
                        ...
                        elements[0] = self.GetEntity<E>(view[index])!;
                        for (let i = 0; i < componentTypes.length; ++i)
                        {
                            elements[i + 1] = self.GetComponent(view[index], componentTypes[i].TypeId)!;
                        }
