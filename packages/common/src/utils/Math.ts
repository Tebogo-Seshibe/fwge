...
export class Maths
{
    ...
    static randomIntBetween: (min: number, max: number) => number = (min: number, max: number) => 
    {
    ...
    static randomFloatBetween: (min: number, max: number) => number = (min: number, max: number) => 
    {
