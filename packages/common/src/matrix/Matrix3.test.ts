...
describe('Matrix3', () =>
{
    ...
    //         {
    //             const matrix = Matrix3.Multiply(1,2,3,4, 5,6,7,8)
    ...
    //         {
    //             const matrix = new Matrix3()
    //             Matrix3.Multiply(1,2,3,4, 5,6,7,8, matrix)
    //             expect(matrix[0]).toBe(19)
    //             expect(matrix[1]).toBe(22)
    //             expect(matrix[2]).toBe(43)
    //             expect(matrix[3]).toBe(50)
    ...
    //         {
    //             const source = new Matrix3(0, 2, 0, 4)
    ...
    //                 7, 8, 9
    //             )
    //             const result = Matrix3.MultiplyVector(matrix, 5, 6)
    ...
    //             Matrix3.MultiplyVector(matrix, 5, 6, result)
    //             expect(result[0]).toBe(17)
    //             expect(result[1]).toBe(39)
    //         })
    ...
    //         it('Should create a new rotation matrix', () =>
    //         {
    //             const matrix = Matrix3.ScaleMatrix(45)
