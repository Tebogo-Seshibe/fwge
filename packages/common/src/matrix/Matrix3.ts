...
export class Matrix3 extends Float32Array
{
    ...
    constructor(_0: Matrix4 | Matrix3 | Matrix3 | NumberArray | number = 0, _1?: number, _2?: number, _3?: number, _4?: number, _5?: number, _6?: number, _7?: number, _8?: number)
    {
        ...
        [ 
            ...
            _3 ?? 0, _4 ?? _0, _5 ??  0,
            _6 ?? 0, _7 ??  0, _8 ?? _0
        ] : _0 instanceof Matrix4 || _0 instanceof Matrix3 ? 
        [
    ...
    static Multiply(
        ...
        _9?: number, _10?: number, _11?: number, _12?: number, _13?: number, _14?: number, _15?: number, _16?: number, _17?: number, _18?: Matrix3): Matrix3
    {
        const out = _8 ?? _2 instanceof Matrix3 ? _2 as Matrix3: new Matrix3()
    ...
    static MultiplyVector(matrix: Matrix3, xyz: number): Vector3
    static MultiplyVector(matrix: Matrix3, xyz: number, out: Vector3): Vector3
    ...
    static ScaleMatrix(xyz: number): Matrix3
    static ScaleMatrix(xyz: number, out: Matrix3): Matrix3
