...
export class Vector4 extends Float32Array implements IsEquatable<Vector4>
{
    ...
    Dot(_0: Vector4 | NumberArray | number, _1?: number, _2?: number, _3?: number): number
    {
        if (typeof _0 === 'number')
        {
            return this[0] * _0 + this[1] * (_1 as number) + this[2] * (_2 as number) + this[3] * (_3 as number);
        }
        else
        {
    ...
    static DistanceSquared(x1: number, y1: number, z1: number, w1: number, x2: number, y2: number, z2: number, w2: number): number;
    static DistanceSquared(vector1: Vector4, vector2: Vector4): number;
    static DistanceSquared(array1: NumberArray, array2: NumberArray): number;
    static DistanceSquared(_0: Vector4 | NumberArray | number, _1: Vector4 | NumberArray | number, _2?: number, _3?: number, _4?: number, _5?: number, _6?: number, _7?: number): number
    {
        let x: number;
        let y: number;
        let z: number;
