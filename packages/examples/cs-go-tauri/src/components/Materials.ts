...
{
    readonly BaseColour: Colour3 = new Colour3(1.0, 1.0, 1.0)
    Subsurface: number = 0.0
    readonly SubsurfaceColour: Colour3 = new Colour3(0.0, 0.0, 0.0)
    ...
    // Alpha: number     = 0.0
    readonly Normal: Colour3 = new Colour3(0.0, 0.0, 0.0)
    readonly ClearcoatNormal: Colour3 = new Colour3(0.0, 0.0, 0.0)
    readonly Tangent: Colour3 = new Colour3(0.0, 0.0, 0.0)
