...
export default class Matrix2 extends Float32Array implements Cloneable<Matrix2>
{
    ...
    Set(m11: Matrix2 | Float32Array | Array<number> | List<number> | number, m12?: number, m21?: number, m22?: number): Matrix2
    {
        return Matrix2.Set
        (
            this,
    ...
    Sum(m11: Matrix2 | Float32Array | Array<number> | List<number> | number, m12?: number, m21?: number, m22?: number): Matrix2
    {
        return Matrix2.Sum
        (
            this,
    ...
    Mult(m11: Matrix2 | Float32Array | Array<number> | List<number> | number, m12?: number, m21?: number, m22?: number): Matrix2
    {
        return Matrix2.Mult
        (
            this,
