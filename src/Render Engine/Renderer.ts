...
export class Renderer
{
    ...
    private RenderObject(gameObject: GameObject): void
    {
        ...
        if (!!gameObject.Mesh && !!gameObject.Material && !!gameObject.Material.Shader)
        {
            ...
            this.SetObjectUniforms(gameObject.Material, shader.Uniforms);
    ...
    private SetObjectUniforms(material: RenderMaterial, uniforms: any)
    {
        FWGE.GL.uniformMatrix4fv(uniforms.Matrix.ModelView, false, this.ModelView.Peek().Buffer);
    ...
    {            
        ...
        while (--i >= 0)
        {
            ...
            {
                let light: AmbientLight | DirectionalLight | PointLight | null = Light.Lights[j];
    ...
    private Draw(vertexCount: number, framebuffer: WebGLFramebuffer | null)
    {
        ...
        FWGE.GL.bindFramebuffer(FWGE.GL.FRAMEBUFFER, null);
        FWGE.GL.drawElements(FWGE.GL.TRIANGLE_STRIP, vertexCount, FWGE.GL.UNSIGNED_SHORT, 0);
        FWGE.GL.bindFramebuffer(FWGE.GL.FRAMEBUFFER, null);
    }
